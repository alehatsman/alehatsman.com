...
Last 7 years I was working as Software Engineer. During this time I was improving my productivity by using right techniques and leveraging right tools in my Developer Enviroment.
...
Vim teaches right habbits. Hands never take off the keys. Keeping them in an optimum position to input text, to scroll, to navigate or to apply commands.
...
<img src="/static/images/developer_enviroment_productivity/tmux_vertical_split.gif" size="medium" round shadow />
