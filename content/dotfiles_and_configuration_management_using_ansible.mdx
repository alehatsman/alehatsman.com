export const meta = { 
  ...
  description: 'Infrastructure as code is de facto standard in the world of devops. Why not to use the same tools for your personal laptop. Got a new mac, run Ansible playbooks and have a ready to use MacBook.', 
