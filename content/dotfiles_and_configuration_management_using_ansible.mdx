...
description: 'Applying DevOps best practices to automate the process of software installation, configuration and synchronization between multiple workstations.'
tags:
  - dotfiles
  - ansible
  - iaac
...
featuredImage: '../static/images/posts/dotfiles_automation_using_ansible/featuredImage.jpeg'
fleaturedImageAlt: 'https://unsplash.com/photos/p1m4B-lhS9Y'
public: true
---
