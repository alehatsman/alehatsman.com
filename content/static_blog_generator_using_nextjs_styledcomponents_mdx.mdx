...
description: 'Constructing a personal blog website utilizing modern frontend technologies with instant deployment, CDN, continues delivery for only 0$ per month.'
tags:
  - JavaScript
  - TypeScript',
  - Next.js',
...
featuredImage: '../static/images/posts/personal_blog_gatsby/featuredImage.jpg'
public: true
---
...
<img src="/images/posts/how_to_create_your_personal_blog_using_nextjs/design_screenshot.png" />
