export const meta = { 
  ...
  description: 'In the era of modern frontend you can build almost any tool and service by hands in hours. In this article, instead of using complex static site generators, I want to show how to build your own using only JavaScript tools.', 
  createdAt: '2019-03-04',
  public: true
};

# How to create a static blog generator using Next.js?
