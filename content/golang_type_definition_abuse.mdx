export const meta = { 
  id: 'golang_type_alias_definition_abuse', 
  title: 'Golang type alias / definition abuse', 
  description: 'Developers tend to bring ideas and approaches from other languages, to the projects they currently work in. Sometimes it perfectly make sence, but sometimes makes code only harder to read and maintain.', 
  createdAt: '2019-05-09',
  public: true
};

# Golang type alias and type definition abuse. 
...
So what drives people to do that. They believe that it will prevent errors when you have for example complex function:
...
Cool right? To use time.Time you have to cast it first to time.Time.
...
I would prefer [][][][]string instead of ArrayOfArrayOfArrayOfEntities.
