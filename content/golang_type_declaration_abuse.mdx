export const meta = { 
  ...
  description: 'What is the difference between Type Alias and Type Definition? What are the best and worst use cases for Type Aliases and Type Definitions? Examples of problematic code from real projects and ideas that you should avoid.', 
...
## How you shouldn't use type declarations?
