...
title: 'Type Aliases vs Type Definitions in GO'
description: 'Difference between Type Alias and Type Definition in Golang. What are the main use cases? Examples of problematic code from real projects.'
...
tags:
  ...
  - definition
  - typesafe
featuredImage: '../static/images/posts/golang_type_aliases_vs_type_declarations/featuredImage.jpg'
featuredImageAlt: 'https://unsplash.com/photos/3G_bySYOzpA'
public: true
---
